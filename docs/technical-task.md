...
По клику правой кнопкой мыши появляется меню, которое содержит пункты: сделать скриншот, сделать вырезку из видео (сделать клип), язык плеера, показать статистику, горячие клавиши.
